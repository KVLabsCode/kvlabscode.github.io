...
export const metadata = {
  ...
  description: 'Cookie Policy for Kovio publisher operating system.',
};
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-surface rounded-xl p-6 border border-white/10">
                  ...
                  <p className="text-muted mb-3">Required for the platform to function properly.</p>
                  <ul className="text-muted/80 text-sm space-y-1 ml-4 list-disc">
                ...
                <div className="bg-surface rounded-xl p-6 border border-white/10">
                  ...
                  <p className="text-muted mb-3">Help us understand how visitors use our website.</p>
                  <ul className="text-muted/80 text-sm space-y-1 ml-4 list-disc">
                ...
                <div className="bg-surface rounded-xl p-6 border border-white/10">
                  ...
                  <p className="text-muted mb-3">Remember your settings and preferences.</p>
                  <ul className="text-muted/80 text-sm space-y-1 ml-4 list-disc">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">5. Updates to Cookie Policy</h2>
              <p className="text-muted leading-relaxed">
            ...
            <section>
              ...
              <p className="text-muted leading-relaxed">
                For questions about cookies, please contact us at <a href="mailto:privacy@kovio.dev" className="text-accent hover:text-accent-hover font-medium">privacy@kovio.dev</a>.
              </p>
            </section>
          </div>
        </div>
