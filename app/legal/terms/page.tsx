...
export const metadata = {
  ...
  description: 'Terms of Use for Kovio publisher operating system.',
};
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">3. Account Ownership and Access</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">4. Use of AI Agent</h2>
              <p className="text-muted leading-relaxed mb-4">
            ...
            <section>
              ...
              <p className="text-muted leading-relaxed">
                For questions about these Terms of Use, please contact us at <a href="mailto:legal@kovio.dev" className="text-accent hover:text-accent-hover font-medium">legal@kovio.dev</a>.
              </p>
            </section>
          </div>
        </div>
