  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-20">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <div className="inline-block px-4 py-2 glass-effect rounded-full mb-6">
                <span className="text-sm text-primary-300 font-semibold">FOR ADVERTISERS &amp; BRANDS</span>
              </div>
        ...
        <section id="advertisers" className="py-16 px-4 sm:px-6 lg:px-8 bg-black/30 relative overflow-hidden">
          {/* Subtle background accents */}
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-primary-900/10 to-transparent pointer-events-none"></div>
          <div className="absolute -top-24 -right-24 w-72 h-72 bg-accent-500/15 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-primary-500/15 rounded-full blur-3xl"></div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-12">
              ...
              <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm">
                <div className="glass-effect rounded-full px-4 py-2 flex items-center gap-2 text-primary-200">
                  <span className="w-2 h-2 rounded-full bg-primary-400"></span>
                  <span>+3.2x click‑through on sponsored answers vs traditional display</span>
                </div>
                <div className="glass-effect rounded-full px-4 py-2 flex items-center gap-2 text-emerald-200">
                  <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
                  <span>94% session retention on Kovio-powered experiences</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="glass-effect-premium rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-3 group-hover:text-accent-300 transition-colors">
                    Contextual, AI-Powered Targeting
                  </h2>
                  <p className="text-gray-300 leading-relaxed">
              ...
              <div className="glass-effect-premium rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-emerald-500/30">
                    <svg className="w-7 h-7 text-white" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-10 text-center">
              <Link href="/waitlist" className="btn-primary text-lg px-10 py-4 inline-block">
