              ...
              <div className="flex-1">
                <div className="glass-effect rounded-2xl rounded-tl-none p-4 border border-white/10 backdrop-blur-sm">
                  ...
                  <div className="space-y-3">
                    <p className="text-xs text-gray-300 mb-2">Your landing page URL</p>
                    <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/20">
                      ...
                      <span className="text-xs text-gray-200">stylevault.com</span>
                    </div>
                    <button className="w-full px-4 py-2 bg-gradient-to-r from-primary-600 to-accent-600 text-white text-xs font-semibold rounded-lg flex items-center justify-center gap-2">
                ...
                <div className="glass-effect rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-[10px] text-accent-300 font-medium">Analyzing...</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-2 gap-2 text-[10px]">
                      <div className="glass-effect rounded-lg p-2 border border-white/10">
                        <p className="text-gray-400 mb-1">Campaign Title</p>
                        <p className="text-white font-medium text-xs">Trendy Styles at StyleVault</p>
                      </div>
                      <div className="glass-effect rounded-lg p-2 border border-white/10">
                        <p className="text-gray-400 mb-1">Keywords</p>
                        <div className="flex flex-wrap gap-1">
                          <span className="px-1.5 py-0.5 rounded-full bg-primary-500/20 text-primary-200 text-[9px]">fashion</span>
                          <span className="px-1.5 py-0.5 rounded-full bg-primary-500/20 text-primary-200 text-[9px]">affordable</span>
                        </div>
                      </div>
                    </div>
                    <div className="glass-effect rounded-lg p-2 border border-white/10">
                      <p className="text-gray-400 text-[10px] mb-1">Ad Message</p>
                      <p className="text-white text-xs">Discover the latest fashion trends and unbeatable prices!</p>
                    </div>
                  </div>
                </div>
                <p className="text-[11px] text-gray-500 mt-2 ml-1">
              ...
              <div className="flex-1">
                <div className="glass-effect rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[10px] text-emerald-300 font-medium">Step 3</span>
                  </div>

                  <div className="grid grid-cols-2 gap-3">
                    <div className="glass-effect rounded-lg p-3 border border-white/10">
                      <p className="text-[10px] text-gray-400 mb-1">CPC Bid</p>
                      <div className="flex items-baseline gap-1">
                        <span className="text-lg font-bold text-white">$10</span>
                        <span className="text-[10px] text-gray-400">per click</span>
                      </div>
                    </div>
                    <div className="glass-effect rounded-lg p-3 border border-white/10">
                      <p className="text-[10px] text-gray-400 mb-1">Total Budget</p>
                      <div className="flex items-baseline gap-1">
                        <span className="text-lg font-bold text-emerald-300">$10k</span>
                        <span className="text-[10px] text-gray-400">campaign</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-effect rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-primary-500 via-accent-500 to-primary-500 rounded-2xl opacity-60 blur transition duration-500 animate-gradient-x"></div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 bg-gray-800/50 rounded-lg px-3 py-2">
                              <p className="text-xs text-gray-200">Where can I find affordable summer dresses?</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 space-y-2">
                              <div className="bg-gray-800/30 rounded-lg px-3 py-2">
                                <p className="text-xs text-gray-300">Here are some great options for affordable summer dresses:</p>
                              </div>

                              {/* Sponsored ad card */}
                              <div className="bg-gradient-to-br from-primary-500/20 to-accent-500/20 border border-primary-500/40 rounded-lg p-3 space-y-2">
                                <div className="flex items-center justify-between">
                                  <span className="px-1.5 py-0.5 bg-primary-500/30 border border-primary-500/50 rounded text-[8px] font-semibold text-primary-200">
                                    SPONSORED
                                  </span>
                                  <span className="text-[8px] text-gray-400">Ad</span>
                                </div>
                                <div>
                                  <p className="text-xs text-white font-semibold mb-1">StyleVault</p>
                                  <p className="text-[10px] text-gray-300 mb-2">Discover the latest fashion trends and unbeatable prices!</p>
                                  <div className="flex items-center gap-2">
                                    <span className="text-[9px] text-primary-300 font-medium">Visit stylevault.com</span>
                                    <svg className="w-3 h-3 text-primary-300" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                                      <path d="M9 5l7 7-7 7" />
                                    </svg>
                                  </div>
                                </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 text-[10px]">
                      <div className="glass-effect rounded-lg p-2 border border-white/10 text-center">
                      ...
                      <div className="glass-effect rounded-lg p-2 border border-white/10 text-center">
                        ...
                        <p className="text-emerald-300 font-semibold">38</p>
                      </div>
                      <div className="glass-effect rounded-lg p-2 border border-white/10 text-center">
                        <p className="text-gray-400 mb-0.5">CTR</p>
                        <p className="text-primary-300 font-semibold">3.2%</p>
                      </div>
                    </div>

                    {/* Advertiser dashboard snapshot */}
                    <div className="relative group">
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-primary-500/60 via-accent-500/60 to-emerald-500/60 rounded-2xl opacity-50 blur transition duration-500 group-hover:opacity-80"></div>
                      <div className="relative bg-gradient-to-br from-gray-950 to-gray-900 rounded-2xl p-4 border border-primary-500/40 space-y-3">
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <p className="text-[11px] text-gray-400 uppercase tracking-wide">Advertiser Dashboard</p>
                            <p className="text-xs font-semibold text-white">StyleVault – Summer Dresses</p>
                          </div>
                          <span className="px-2 py-0.5 bg-emerald-500/15 border border-emerald-500/40 rounded-full text-[9px] font-semibold text-emerald-300 flex items-center gap-1">
                        ...
                        <div className="grid grid-cols-3 gap-2 text-[10px]">
                          <div className="glass-effect rounded-lg p-2 border border-white/10">
                            <p className="text-gray-400 mb-0.5">Total Impressions</p>
                            <p className="text-white font-semibold">128,940</p>
                            <p className="text-[9px] text-emerald-300">+24% vs plan</p>
                          </div>
                          <div className="glass-effect rounded-lg p-2 border border-white/10">
                            <p className="text-gray-400 mb-0.5">Conversions</p>
                            <p className="text-emerald-300 font-semibold">3,214</p>
                            <p className="text-[9px] text-emerald-300">3.3% CVR</p>
                          </div>
                          <div className="glass-effect rounded-lg p-2 border border-white/10">
                            <p className="text-gray-400 mb-0.5">ROAS</p>
                            <p className="text-primary-200 font-semibold">3.1x</p>
                            <p className="text-[9px] text-gray-400">vs paid social</p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-5 gap-3 items-stretch">
                          {/* Trend sparkline */}
                          <div className="col-span-3 glass-effect rounded-lg p-2 border border-primary-500/30 flex flex-col justify-between">
                            <div className="flex items-center justify-between mb-1">
                              <p className="text-[10px] text-gray-300">Conversions over time</p>
                              <span className="text-[9px] text-emerald-300 font-medium">+41% this week</span>
                            </div>
                            <div className="mt-1 h-10 w-full rounded-md bg-gradient-to-r from-primary-500/20 via-accent-500/30 to-emerald-500/20 relative overflow-hidden">
                              <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-primary-500/60 via-accent-500/60 to-transparent" />
                              <div className="absolute inset-1 flex items-end justify-between gap-1">
                          ...
                          {/* Top intents */}
                          <div className="col-span-2 glass-effect rounded-lg p-2 border border-white/10 flex flex-col">
                            <p className="text-[10px] text-gray-300 mb-1">Top live queries</p>
